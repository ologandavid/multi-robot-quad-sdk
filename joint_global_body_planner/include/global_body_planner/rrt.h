...
class RRT {
 public:
   ...
   */
  /*
  int attemptConnect2(const MultipleState &s_existing, const MultipleState &s, double t_s_rob1, double t_s_rob2,
...
*/
   ...
   */
  /*
  int attemptConnect2(const MultipleState &s_existing, const MultipleState &s,
                     MultipleStateActionResult &result,
                     const PlannerConfig &planner_config, int direction);
   */
   ...
   */
  virtual int extend(PlannerClass &T, const MultipleState &s,
                     const PlannerConfig &planner_config, int direction,
   ...
   */
  std::vector<MultipleState> getStateSequence(PlannerClass &T, std::vector<int> path);
   ...
   */
  std::vector<MultipleAction> getActionSequence(PlannerClass &T, std::vector<int> path);
 ...
 protected:
  ...
  double r1dist_to_goal_;
  double r2dist_to_goal_;
