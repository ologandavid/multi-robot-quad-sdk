...
class PlannerClass : public GraphClass {
 public:
   ...
   */
  MultipleState randomState(const PlannerConfig &planner_config);
   ...
   */
  std::vector<int> neighborhoodN(MultipleState s, int N) const;
   ...
   */
  int getNearestNeighbor(MultipleState q) const;
