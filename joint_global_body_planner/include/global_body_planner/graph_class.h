...
class GraphClass {
 public:
   ...
   */
  void addVertex(int index, MultipleState s);
   ...
   */
  MultipleState getVertex(int index);
   ...
   */
  void addAction(int idx, MultipleAction a);
   ...
   */
  MultipleAction getAction(int idx);
   ...
   */
  virtual void init(MultipleState s);

 protected:
  /// Map from vertex indices to corresponding states
  std::unordered_map<int, MultipleState> vertices;

  /// Map from vertex indices to the actions leading to those vertices
  std::unordered_map<int, MultipleAction> actions;
