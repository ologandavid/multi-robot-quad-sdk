...
class GBPL : public RRT {
 public:
   ...
   */
  int connect(PlannerClass &T, MultipleState s, const PlannerConfig &planner_config,
   ...
   */
  std::vector<MultipleAction> getActionSequenceReverse(PlannerClass &T,
                                               std::vector<int> path);
   ...
   * @param[in] planner_config Configuration parameters
   */
  void postProcessPath(std::vector<MultipleState> &state_sequence,
   ...
   */
  void extractClosestPath(PlannerClass &Ta, const MultipleState &s_goal,
                          std::vector<MultipleState> &state_sequence,
                          std::vector<MultipleAction> &action_sequence,
                          const PlannerConfig &planner_config);
   ...
   */
  int findPlan(const PlannerConfig &planner_config, MultipleState s_start, MultipleState s_goal,
               std::vector<MultipleState> &state_sequence,
               std::vector<MultipleAction> &action_sequence, ros::Publisher &tree_pub);
