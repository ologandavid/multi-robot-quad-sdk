...
class RRT {
 public:
   ...
   * REACHED)
   */
  int attemptConnect(std::vector<State> &first_robot_path, const State &s_existing, const State &s, double t_s,
   ...
   * REACHED)
   */
  int attemptConnect(std::vector<State> &first_robot_path, const State &s_existing, const State &s,
                     StateActionResult &result,
                     const PlannerConfig &planner_config, int direction);
   ...
   */
  virtual int extend(std::vector<State> &first_robot_path, PlannerClass &T, const State &s,
                     const PlannerConfig &planner_config, int direction,
   ...
   * other in the tree
   */
  bool newConfig(std::vector<State> &first_robot_path, State s, State s_near, StateActionResult &result,
                 const PlannerConfig &planner_config, int direction,
                 ros::Publisher &tree_pub);
