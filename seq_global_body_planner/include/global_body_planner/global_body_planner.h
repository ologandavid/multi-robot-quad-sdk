...
class GlobalBodyPlanner {
 ...
 private:
  ...
  FullState r1start_state_ ,r2start_state_ ;

  /// Goal state for planner
  FullState r1goal_state_ , r2goal_state_;

  /// Current robot state
  FullState r1robot_state_,r2robot_state_;
  ...
  std::vector<State> r1state_sequence_ , r2state_sequence_;

  /// Sequence of discrete actions in the plan
  std::vector<Action> r1action_sequence_, r2action_sequence_;
